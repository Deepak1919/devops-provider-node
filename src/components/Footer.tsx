        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-start">
          <div className="max-w-2xl lg:text-left">
            ...
            <p className="text-muted-foreground text-sm mb-6">
              On-prem, cloud, hybrid infrastructure, AI-for-DevOps consulting, and ongoing DevOps
              support for startups, businesses, and engineering teams backed by a team with 10+ years
              of experience.
            </p>
            ...
            <div className="mb-6 flex flex-wrap gap-3 text-xs text-muted-foreground">
              ...
              <span className="rounded-full border border-border/60 px-3 py-1.5">Supporting teams worldwide</span>
